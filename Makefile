...
WEBVER_CFLAGS:=-DINCLUDE_ALL -sEXPORTED_RUNTIME_METHODS=requestFullscreen -O2
...
usage:
	...
	@echo "make webver		to build web demo on SDL3 + Emscripten (try to run 'embuilder build sdl3' if first time)"
